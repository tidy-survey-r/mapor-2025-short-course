# Introduction {background-color='{{< brand color secondary >}}'}
...
![](images/RebeccaPowell_Headshot.jpeg){fig-align="center" width=200px}
...
![](images/IsabellaVelasquez_Headshot.jpeg){fig-align="center" width=200px}
...
- At the end of this tutorial, you should be able to 
   ...
   - Conduct basic logistic regression
...
## Logistics
  ...
  - All materials are found at:
    - <https://tidy-survey-r.github.io/mapor-2025-short-course/full-slide-deck.html> (Site)
